...
async def start_message(app, message):
    ...
    text = f"Bonjour {message.from_user.mention()}<a href='https://telegra.ph/file/11379aba315ba245ebc7b.jpg'>!</a> Je suis le bot VideoEncoder, qui fera des merveilles avec votre fichier."
...
Supports : <a href='https://telegra.ph/Supports-03-29'>cliquez ici</a>"""
